...
function sendConfirmation() {
    ...
    // تفريغ السلة وحقول الإدخال بعد 5 ثوانٍ
    setTimeout(() => {
        cart = [];
        updateCart();
        nameInput.value = "";
        phoneInput.value = "";
        messageInput.value = "";
        showMessageAtBottom(" تم إرسال الأوردر وتفريغ السلة ✅ ", "confirmation-message");
    }, 5000);
}

// عرض رسالة في أسفل الصفحة مع إمكانية التحكم في CSS
function showMessageAtBottom(msg, className) {
